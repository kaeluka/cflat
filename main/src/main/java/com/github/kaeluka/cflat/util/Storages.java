...
public class Storages {
    ...
    public static List<Supplier<Storage>> genericStorages2D() {
        final ArrayList<Supplier<Storage>> ret = new ArrayList<>();
        ...
        ret.add(new NamedSupplier<Storage>(() -> SparseStorage.getFor(SparseStorage.USAGE.SIZE), "SparseStorage(SIZE)"));
        ret.add(new NamedSupplier<Storage>(() -> SparseStorage.getFor(SparseStorage.USAGE.INSERT_PERFORMANCE), "SparseStorage(PERFORMANCE)"));
        return ret;
    }
